...
@section('content')
    <div id="content" class="float_r">
        <h1>Varsity Link Ecommerce Privacy Policy</h1>
        <h3>Last Update 11 November 2021</h3>
        ...
        <h4>Administer sweepstakes, promotions, and contests.</h4>
